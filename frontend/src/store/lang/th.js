const th = {
    ...
    editor: {
        ...
        settings: {
            ...
            status: {
                ...
                draft: "แบบร่าง",
                open: "เปิดใช้งาน",
                openForever: "เปิดใช้งานตลอดเวลา",
                closedForever: "ปิดรับข้อมูลถาวร",
                ...
                openForeverDesc: "ฟอร์มจะเปิดตลอดเวลา จนกว่าจะตั้งค่าให้มันปิด",
                closedForeverDesc: "ฟอร์มจะปิดตลอดเวลา จนกว่าจะตั้งค่าให้มันเปิด",
    ...
    email: {
        title: "เทมเพลตอีเมลของฉัน",
        description: "จัดการและปรับแต่งเทมเพลตสำหรับส่งอีเมลการแจ้งเตือนและการตอบกลับ",
        lastModified: "แก้ไขล่าสุด",
        edit: "แก้ไข",
        back: "ย้อนกลับ",
        emailSubject: "หัวข้ออีเมล",
        dynamicVariables: "ตัวแปรแบบไดนามิก",
        shortcut: "เมนูลัด",
        switchTemplate: "สลับไปยังเทมเพลตอื่น",
        helpText: "คลิกตัวแปรเพื่อแทรกในตำแหน่งเคอร์เซอร์ปัจจุบันของคุณภายในช่องแก้ไขข้อความ",
        subjectPlaceholder: "ระบุหัวข้ออีเมลที่นี่...",
        editorPlaceholder: "สวัสดีคุณ {{Responder}}, ...",
        saveStatus: {
            saving: "กำลังบันทึก...",
            savedAt: "บันทึกครั้งล่าสุดเมื่อ {time}",
            draftSaved: "บันทึกร่างจดหมายเรียบร้อยแล้ว"
        },
        templates: {
            invitationCollaboration: {
                desc: "ส่งอีเมลเชิญผู้ใช้งานท่านอื่นเข้ามาร่วมแก้ไขและจัดการแบบสอบถามร่วมกัน"
            },
            invitationOrganization: {
                desc: "ส่งอีเมลแจ้งเตือนแบบสอบถามไปยังสมาชิกภายในองค์กรหรือผู้ใช้งานที่ระบุ"
            },
            submissionConfirmation: {
                desc: "ส่งอีเมลยืนยันการส่งข้อมูลให้กับผู้ตอบแบบสอบถามโดยอัตโนมัติหลังจากส่งแบบฟอร์ม"
            },
