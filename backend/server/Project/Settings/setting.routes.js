...
const controll = require("./service/controll");
...
router.get("/controll", controll.onQuerys);
router.post("/controll", controll.onCreate);
router.put("/controll", controll.onUpdate);
router.delete("/controll", controll.onDelete);
